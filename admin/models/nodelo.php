 ...
 *Modelo Nodelo
 */
class VehiculoModelNodelo extends JModelAdmin
{
        /**
         ...
         * @since       2.5
         */
        public function getTable($type = 'Nodelo', $prefix = 'VehiculoTable', $config = array()) 
        {
        ...
        {
                // Get the form.
                $form = $this->loadForm('com_vehiculo.nodelo', 'nodelo',
        ...
        protected function loadFormData() 
        {
                ...
                $data = JFactory::getApplication()->getUserState('com_vehiculo.edit.nodelo.data', array());
                if (empty($data)) 
                {
                        $data = $this->getItem();
                }
