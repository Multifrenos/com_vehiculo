 ...
 */
class VehiculoModelCombustible extends JModelAdmin
{
        /**
         ...
         * @since       2.5
         */
        public function getTable($type = 'Combustible', $prefix = 'VehiculoTable', $config = array()) 
        {
        ...
        {
                // Get the form.
                $form = $this->loadForm('com_vehiculo.combustible', 'combustible',
        ...
        protected function loadFormData() 
        {
                ...
                $data = JFactory::getApplication()->getUserState('com_vehiculo.edit.combustible.data', array());
                if (empty($data)) 
                {
                        $data = $this->getItem();
                }
