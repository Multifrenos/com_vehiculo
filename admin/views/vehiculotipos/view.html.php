...
class VehiculoViewVehiculotipos extends JViewLegacy
{
        protected $items;
        ...
        protected function addToolBar() 
        {
			    ...
			    JToolbarHelper::title(JText::_('Tipos de Vehiculos'),'joomla');
                JToolbarHelper::deleteList('', 'vehiculotipo.delete');
                JToolbarHelper::editList('vehiculotipo.edit');
                JToolbarHelper::addNew('vehiculotipo.add');
