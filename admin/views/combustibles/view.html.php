...
class VehiculoViewCombustibles extends JViewLegacy
{
        protected $items;
        ...
        protected function addToolBar() 
        {
			    ...
			    JToolbarHelper::title(JText::_('Tipos de combustible de Vehiculos'),'joomla');
                JToolbarHelper::deleteList('', 'combustible.delete');
                JToolbarHelper::editList('combustible.edit');
                JToolbarHelper::addNew('combustible.add');
